    ...
    <nav className='flex items-center justify-between flex-wrap bg-gray-900 p-6'>
        ...
        <div className="block">
             <button 
                ...
                border rounded border-gray-700 hover:text-white hover:border-white"
                > 
        ...
        { isVisible ? ( 
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    <Button className="p-3 m-5 bg-gray-700 justify-center">
                        <div>
                            <Link to="/" onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0 
                             text-gray-500 hover:text-white mr-4'>
                            Home
                            </Link>
                        </div>
                    </Button>
                    ...
                    <Button className="p-3 m-5 bg-gray-700 justify-center">
                        <div>
                            <Link to="/Whiskey" onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0 
                             text-gray-500 hover:text-white mr-4'>
                            Whiskey
                            </Link>
                        </div>
                    ...
                    </Button>
                    {
                        ...
                        <div>
                            <Link to="/" onClick={ () => { signInOnClick()}} className="flex place-items-center mt-4
                             lg:inline-block lg:mt-0 text-gray-500 hover:text-white">
                                Login
                            </Link>
                        </div>
                    </Button>
